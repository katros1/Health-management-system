    ...
    <body>
        ...
        <div class="container">
            <div class="content">
                ...
                <a href="<%=request.getContextPath()%>/nurse-new" class="btn btn-success btn-add"><button>Add New Nurse</button></a>
                    ...
                    <tbody>
                        <c:forEach var="nurse" items="${listNurses}">
                            <tr>
                                ...
                                <td>
                                   <a href="nurse-edit?id=<c:out value='${nurse.id}' />" > <button class="btn-primary">
                                            <i class="fas fa-edit"></i> Edit
                                        
                                    </button></a>
                                   <a href="nurse-delete?id=<c:out value='${nurse.id}' />"> <button class="btn-danger">  
